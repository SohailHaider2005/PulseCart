  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with PulseCart! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by PulseCart.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to PulseCart's acceptance. We may refuse to
        ...
        <p>
          ...
          PulseCart. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock PulseCart products. We
        ...
        <p>
          ...
          taxes, except for those based on PulseCart's income. If
          PulseCart is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without PulseCart's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold PulseCart harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between PulseCart and
