    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, PulseCart.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with PulseCart
          ...
          agreed to or set forth in writing by PulseCart, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to PulseCart's acceptance. This means
          PulseCart may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, PulseCart
        ...
        <p>
          ...
          and it is accepted by PulseCart. Prices for products displayed on
          ...
          website may differ from those in stores that stock PulseCart
          products, as these stores are independent of PulseCart.
          PulseCart reserves the right to amend pricing for any pricing
          ...
          submitted an online order, PulseCart will notify you of the error
        ...
        <p>
          ...
          PulseCart reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse PulseCart if it pays, any
          taxes, except for those based on PulseCart's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by PulseCart for when the
          ...
          are beyond our control. PulseCart cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by PulseCart, customer
          may not cancel such accepted order without PulseCart’s prior
          ...
          expenses. The product(s) must be returned to PulseCart within
        ...
        <p>
          ...
          indemnify and hold PulseCart harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>PulseCart</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@PulseCart.com</span>
        </p>
      </div>
    </div>
  );
